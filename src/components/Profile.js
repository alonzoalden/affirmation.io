    ...
    return (
      <Card style={cardStyle} zDepth={1}>
        ...
        <CardText style={{fontFamily: 'Nunito'}}>
          <span>
            <div style={{color: '#0093FF', fontWeight: 'bold'}}>Job: <span style={{color: 'black'}}>{profile.job}</span></div>
          </span>
          <span>
            <div style={{color: '#0093FF', fontWeight: 'bold'}}>Location: <span style={{color: 'black'}}>{profile.location}</span></div>
          </span>
